...
class __TwigTemplate_289d6559e069655007e8fda72e68badbc1daafacca39597066c651daf27f6d1b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "C:\\Users\\mbach\\Documents\\GitHub\\pack-go-web\\PackandGo\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\form_help.html.php");
    }
}
